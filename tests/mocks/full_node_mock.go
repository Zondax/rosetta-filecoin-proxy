...
func (_c *FullNode_AuthNew_Call) Run(run func(ctx context.Context, perms []auth.Permission)) *FullNode_AuthNew_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 []auth.Permission
		if args[1] != nil {
			arg1 = args[1].([]auth.Permission)
		}
		run(
			arg0,
			arg1,
...
func (_c *FullNode_ChainExport_Call) Run(run func(ctx context.Context, nroots abi.ChainEpoch, oldmsgskip bool, tsk types.TipSetKey)) *FullNode_ChainExport_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 abi.ChainEpoch
		if args[1] != nil {
			arg1 = args[1].(abi.ChainEpoch)
		}
		var arg2 bool
		if args[2] != nil {
			arg2 = args[2].(bool)
		}
		var arg3 types.TipSetKey
		if args[3] != nil {
			arg3 = args[3].(types.TipSetKey)
		}
		run(
			arg0,
			arg1,
...
func (_c *FullNode_ChainExportRangeInternal_Call) Run(run func(ctx context.Context, head types.TipSetKey, tail types.TipSetKey, cfg api.ChainExportConfig)) *FullNode_ChainExportRangeInternal_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 types.TipSetKey
		if args[1] != nil {
			arg1 = args[1].(types.TipSetKey)
		}
		var arg2 types.TipSetKey
		if args[2] != nil {
			arg2 = args[2].(types.TipSetKey)
		}
		var arg3 api.ChainExportConfig
		if args[3] != nil {
			arg3 = args[3].(api.ChainExportConfig)
		}
		run(
			arg0,
			arg1,
...
// ChainGetFinalizedTipSet provides a mock function for the type FullNode
func (_mock *FullNode) ChainGetFinalizedTipSet(ctx context.Context) (*types.TipSet, error) {
...
func (_c *FullNode_ChainGetFinalizedTipSet_Call) Return(tipSet *types.TipSet, err error) *FullNode_ChainGetFinalizedTipSet_Call {
	_c.Call.Return(tipSet, err)
	return _c
}

func (_c *FullNode_ChainGetFinalizedTipSet_Call) RunAndReturn(run func(ctx context.Context) (*types.TipSet, error)) *FullNode_ChainGetFinalizedTipSet_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *FullNode_ChainHotGC_Call) Run(run func(ctx context.Context, opts api.HotGCOpts)) *FullNode_ChainHotGC_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 api.HotGCOpts
		if args[1] != nil {
			arg1 = args[1].(api.HotGCOpts)
		}
		run(
			arg0,
			arg1,
...
func (_c *FullNode_ChainPrune_Call) Run(run func(ctx context.Context, opts api.PruneOpts)) *FullNode_ChainPrune_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 api.PruneOpts
		if args[1] != nil {
			arg1 = args[1].(api.PruneOpts)
		}
		run(
			arg0,
			arg1,
...
func (_c *FullNode_EthAddressToFilecoinAddress_Call) Run(run func(ctx context.Context, ethAddress ethtypes.EthAddress)) *FullNode_EthAddressToFilecoinAddress_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 ethtypes.EthAddress
		if args[1] != nil {
			arg1 = args[1].(ethtypes.EthAddress)
		}
		run(
			arg0,
			arg1,
...
func (_c *FullNode_EthCall_Call) Run(run func(ctx context.Context, tx ethtypes.EthCall, blkParam ethtypes.EthBlockNumberOrHash)) *FullNode_EthCall_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 ethtypes.EthCall
		if args[1] != nil {
			arg1 = args[1].(ethtypes.EthCall)
		}
		var arg2 ethtypes.EthBlockNumberOrHash
		if args[2] != nil {
			arg2 = args[2].(ethtypes.EthBlockNumberOrHash)
		}
		run(
			arg0,
			arg1,
...
func (_c *FullNode_EthEstimateGas_Call) Run(run func(ctx context.Context, p jsonrpc.RawParams)) *FullNode_EthEstimateGas_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 jsonrpc.RawParams
		if args[1] != nil {
			arg1 = args[1].(jsonrpc.RawParams)
		}
		run(
			arg0,
			arg1,
...
func (_c *FullNode_EthGetBlockByHash_Call) Run(run func(ctx context.Context, blkHash ethtypes.EthHash, fullTxInfo bool)) *FullNode_EthGetBlockByHash_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 ethtypes.EthHash
		if args[1] != nil {
			arg1 = args[1].(ethtypes.EthHash)
		}
		var arg2 bool
		if args[2] != nil {
			arg2 = args[2].(bool)
...
func (_mock *FullNode) EthGetBlockReceipts(ctx context.Context, blkParam ethtypes.EthBlockNumberOrHash) ([]*ethtypes.EthTxReceipt, error) {
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, ethtypes.EthBlockNumberOrHash) ([]*ethtypes.EthTxReceipt, error)); ok {
		return returnFunc(ctx, blkParam)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, ethtypes.EthBlockNumberOrHash) []*ethtypes.EthTxReceipt); ok {
...
func (_c *FullNode_EthGetBlockReceipts_Call) Run(run func(ctx context.Context, blkParam ethtypes.EthBlockNumberOrHash)) *FullNode_EthGetBlockReceipts_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 ethtypes.EthBlockNumberOrHash
		if args[1] != nil {
			arg1 = args[1].(ethtypes.EthBlockNumberOrHash)
		}
		run(
			arg0,
			arg1,
...
func (_c *FullNode_EthGetBlockReceipts_Call) Return(ethTxReceipts []*ethtypes.EthTxReceipt, err error) *FullNode_EthGetBlockReceipts_Call {
	_c.Call.Return(ethTxReceipts, err)
	return _c
}

func (_c *FullNode_EthGetBlockReceipts_Call) RunAndReturn(run func(ctx context.Context, blkParam ethtypes.EthBlockNumberOrHash) ([]*ethtypes.EthTxReceipt, error)) *FullNode_EthGetBlockReceipts_Call {
	_c.Call.Return(run)
	return _c
}

// EthGetBlockReceiptsLimited provides a mock function for the type FullNode
func (_mock *FullNode) EthGetBlockReceiptsLimited(ctx context.Context, blkParam ethtypes.EthBlockNumberOrHash, limit abi.ChainEpoch) ([]*ethtypes.EthTxReceipt, error) {
	...
	var r0 []*ethtypes.EthTxReceipt
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, ethtypes.EthBlockNumberOrHash, abi.ChainEpoch) ([]*ethtypes.EthTxReceipt, error)); ok {
		return returnFunc(ctx, blkParam, limit)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, ethtypes.EthBlockNumberOrHash, abi.ChainEpoch) []*ethtypes.EthTxReceipt); ok {
...
func (_c *FullNode_EthGetBlockReceiptsLimited_Call) Run(run func(ctx context.Context, blkParam ethtypes.EthBlockNumberOrHash, limit abi.ChainEpoch)) *FullNode_EthGetBlockReceiptsLimited_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg2 abi.ChainEpoch
		if args[2] != nil {
			arg2 = args[2].(abi.ChainEpoch)
		}
		run(
			arg0,
			arg1,
...
func (_c *FullNode_EthGetBlockReceiptsLimited_Call) Return(ethTxReceipts []*ethtypes.EthTxReceipt, err error) *FullNode_EthGetBlockReceiptsLimited_Call {
	_c.Call.Return(ethTxReceipts, err)
	return _c
}

func (_c *FullNode_EthGetBlockReceiptsLimited_Call) RunAndReturn(run func(ctx context.Context, blkParam ethtypes.EthBlockNumberOrHash, limit abi.ChainEpoch) ([]*ethtypes.EthTxReceipt, error)) *FullNode_EthGetBlockReceiptsLimited_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *FullNode) EthGetBlockTransactionCountByNumber(ctx context.Context, blkNum string) (ethtypes.EthUint64, error) {
	...
	var r0 ethtypes.EthUint64
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) (ethtypes.EthUint64, error)); ok {
		return returnFunc(ctx, blkNum)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) ethtypes.EthUint64); ok {
...
func (_c *FullNode_EthGetBlockTransactionCountByNumber_Call) RunAndReturn(run func(ctx context.Context, blkNum string) (ethtypes.EthUint64, error)) *FullNode_EthGetBlockTransactionCountByNumber_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *FullNode_EthGetFilterChanges_Call) Run(run func(ctx context.Context, id ethtypes.EthFilterID)) *FullNode_EthGetFilterChanges_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 ethtypes.EthFilterID
		if args[1] != nil {
			arg1 = args[1].(ethtypes.EthFilterID)
		}
		run(
			arg0,
			arg1,
...
func (_c *FullNode_EthGetLogs_Call) Run(run func(ctx context.Context, filter *ethtypes.EthFilterSpec)) *FullNode_EthGetLogs_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 *ethtypes.EthFilterSpec
		if args[1] != nil {
			arg1 = args[1].(*ethtypes.EthFilterSpec)
		}
		run(
			arg0,
			arg1,
...
func (_c *FullNode_EthGetStorageAt_Call) Run(run func(ctx context.Context, address1 ethtypes.EthAddress, position ethtypes.EthBytes, blkParam ethtypes.EthBlockNumberOrHash)) *FullNode_EthGetStorageAt_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg2 ethtypes.EthBytes
		if args[2] != nil {
			arg2 = args[2].(ethtypes.EthBytes)
		}
		var arg3 ethtypes.EthBlockNumberOrHash
		if args[3] != nil {
			arg3 = args[3].(ethtypes.EthBlockNumberOrHash)
		}
		run(
			arg0,
			arg1,
...
func (_c *FullNode_EthGetTransactionByBlockHashAndIndex_Call) Run(run func(ctx context.Context, blkHash ethtypes.EthHash, txIndex ethtypes.EthUint64)) *FullNode_EthGetTransactionByBlockHashAndIndex_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg2 ethtypes.EthUint64
		if args[2] != nil {
			arg2 = args[2].(ethtypes.EthUint64)
		}
		run(
			arg0,
			arg1,
...
func (_mock *FullNode) EthGetTransactionReceipt(ctx context.Context, txHash ethtypes.EthHash) (*ethtypes.EthTxReceipt, error) {
	ret := _mock.Called(ctx, txHash)
	...
	var r0 *ethtypes.EthTxReceipt
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, ethtypes.EthHash) (*ethtypes.EthTxReceipt, error)); ok {
		return returnFunc(ctx, txHash)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, ethtypes.EthHash) *ethtypes.EthTxReceipt); ok {
		r0 = returnFunc(ctx, txHash)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*ethtypes.EthTxReceipt)
...
func (_c *FullNode_EthGetTransactionReceipt_Call) Return(ethTxReceipt *ethtypes.EthTxReceipt, err error) *FullNode_EthGetTransactionReceipt_Call {
	_c.Call.Return(ethTxReceipt, err)
	return _c
}

func (_c *FullNode_EthGetTransactionReceipt_Call) RunAndReturn(run func(ctx context.Context, txHash ethtypes.EthHash) (*ethtypes.EthTxReceipt, error)) *FullNode_EthGetTransactionReceipt_Call {
	_c.Call.Return(run)
	return _c
}

// EthGetTransactionReceiptLimited provides a mock function for the type FullNode
func (_mock *FullNode) EthGetTransactionReceiptLimited(ctx context.Context, txHash ethtypes.EthHash, limit abi.ChainEpoch) (*ethtypes.EthTxReceipt, error) {
	ret := _mock.Called(ctx, txHash, limit)
	...
	var r0 *ethtypes.EthTxReceipt
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, ethtypes.EthHash, abi.ChainEpoch) (*ethtypes.EthTxReceipt, error)); ok {
		return returnFunc(ctx, txHash, limit)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, ethtypes.EthHash, abi.ChainEpoch) *ethtypes.EthTxReceipt); ok {
		r0 = returnFunc(ctx, txHash, limit)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*ethtypes.EthTxReceipt)
...
func (_c *FullNode_EthGetTransactionReceiptLimited_Call) Return(ethTxReceipt *ethtypes.EthTxReceipt, err error) *FullNode_EthGetTransactionReceiptLimited_Call {
	_c.Call.Return(ethTxReceipt, err)
	return _c
}

func (_c *FullNode_EthGetTransactionReceiptLimited_Call) RunAndReturn(run func(ctx context.Context, txHash ethtypes.EthHash, limit abi.ChainEpoch) (*ethtypes.EthTxReceipt, error)) *FullNode_EthGetTransactionReceiptLimited_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *FullNode_EthSendRawTransaction_Call) Run(run func(ctx context.Context, rawTx ethtypes.EthBytes)) *FullNode_EthSendRawTransaction_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 ethtypes.EthBytes
		if args[1] != nil {
			arg1 = args[1].(ethtypes.EthBytes)
		}
		run(
			arg0,
			arg1,
...
func (_c *FullNode_EthTraceFilter_Call) Run(run func(ctx context.Context, filter ethtypes.EthTraceFilterCriteria)) *FullNode_EthTraceFilter_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 ethtypes.EthTraceFilterCriteria
		if args[1] != nil {
			arg1 = args[1].(ethtypes.EthTraceFilterCriteria)
		}
		run(
			arg0,
			arg1,
...
func (_c *FullNode_EthUnsubscribe_Call) Run(run func(ctx context.Context, id ethtypes.EthSubscriptionID)) *FullNode_EthUnsubscribe_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 ethtypes.EthSubscriptionID
		if args[1] != nil {
			arg1 = args[1].(ethtypes.EthSubscriptionID)
		}
		run(
			arg0,
			arg1,
...
func (_c *FullNode_F3GetOrRenewParticipationTicket_Call) Run(run func(ctx context.Context, minerID address.Address, previous api.F3ParticipationTicket, instances uint64)) *FullNode_F3GetOrRenewParticipationTicket_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg2 api.F3ParticipationTicket
		if args[2] != nil {
			arg2 = args[2].(api.F3ParticipationTicket)
		}
		var arg3 uint64
		if args[3] != nil {
			arg3 = args[3].(uint64)
...
// F3GetPowerTableByInstance provides a mock function for the type FullNode
func (_mock *FullNode) F3GetPowerTableByInstance(ctx context.Context, instance uint64) (gpbft.PowerEntries, error) {
	ret := _mock.Called(ctx, instance)
	...
	var r0 gpbft.PowerEntries
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, uint64) (gpbft.PowerEntries, error)); ok {
		return returnFunc(ctx, instance)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, uint64) gpbft.PowerEntries); ok {
		r0 = returnFunc(ctx, instance)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(gpbft.PowerEntries)
...
func (_c *FullNode_F3GetPowerTableByInstance_Call) Return(powerEntries gpbft.PowerEntries, err error) *FullNode_F3GetPowerTableByInstance_Call {
	_c.Call.Return(powerEntries, err)
	return _c
}

func (_c *FullNode_F3GetPowerTableByInstance_Call) RunAndReturn(run func(ctx context.Context, instance uint64) (gpbft.PowerEntries, error)) *FullNode_F3GetPowerTableByInstance_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *FullNode_F3Participate_Call) Run(run func(ctx context.Context, ticket api.F3ParticipationTicket)) *FullNode_F3Participate_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 api.F3ParticipationTicket
		if args[1] != nil {
			arg1 = args[1].(api.F3ParticipationTicket)
		}
		run(
			arg0,
			arg1,
...
func (_c *FullNode_GasEstimateGasPremium_Call) Run(run func(context1 context.Context, nblocksincl uint64, sender address.Address, gaslimit int64, tsk types.TipSetKey)) *FullNode_GasEstimateGasPremium_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg4 types.TipSetKey
		if args[4] != nil {
			arg4 = args[4].(types.TipSetKey)
		}
		run(
			arg0,
			arg1,
...
func (_c *FullNode_GasEstimateMessageGas_Call) Run(run func(context1 context.Context, message *types.Message, messageSendSpec *api.MessageSendSpec, tipSetKey types.TipSetKey)) *FullNode_GasEstimateMessageGas_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg2 *api.MessageSendSpec
		if args[2] != nil {
			arg2 = args[2].(*api.MessageSendSpec)
		}
		var arg3 types.TipSetKey
		if args[3] != nil {
			arg3 = args[3].(types.TipSetKey)
...
func (_c *FullNode_GetActorEventsRaw_Call) Run(run func(ctx context.Context, filter *types.ActorEventFilter)) *FullNode_GetActorEventsRaw_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 *types.ActorEventFilter
		if args[1] != nil {
			arg1 = args[1].(*types.ActorEventFilter)
		}
		run(
			arg0,
			arg1,
...
func (_c *FullNode_MarketAddBalance_Call) Run(run func(ctx context.Context, wallet address.Address, addr address.Address, amt types.BigInt)) *FullNode_MarketAddBalance_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg3 types.BigInt
		if args[3] != nil {
			arg3 = args[3].(types.BigInt)
		}
		run(
			arg0,
			arg1,
...
func (_c *FullNode_MarketReleaseFunds_Call) Run(run func(ctx context.Context, addr address.Address, amt types.BigInt)) *FullNode_MarketReleaseFunds_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg2 types.BigInt
		if args[2] != nil {
			arg2 = args[2].(types.BigInt)
		}
		run(
			arg0,
			arg1,
...
func (_c *FullNode_MinerCreateBlock_Call) Run(run func(context1 context.Context, blockTemplate *api.BlockTemplate)) *FullNode_MinerCreateBlock_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 *api.BlockTemplate
		if args[1] != nil {
			arg1 = args[1].(*api.BlockTemplate)
		}
		run(
			arg0,
			arg1,
...
func (_c *FullNode_MpoolBatchPush_Call) Run(run func(context1 context.Context, signedMessages []*types.SignedMessage)) *FullNode_MpoolBatchPush_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 []*types.SignedMessage
		if args[1] != nil {
			arg1 = args[1].([]*types.SignedMessage)
		}
		run(
			arg0,
			arg1,
...
func (_c *FullNode_MpoolCheckMessages_Call) Run(run func(context1 context.Context, messagePrototypes []*api.MessagePrototype)) *FullNode_MpoolCheckMessages_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 []*api.MessagePrototype
		if args[1] != nil {
			arg1 = args[1].([]*api.MessagePrototype)
		}
		run(
			arg0,
			arg1,
...
func (_c *FullNode_MpoolSetConfig_Call) Run(run func(context1 context.Context, mpoolConfig *types.MpoolConfig)) *FullNode_MpoolSetConfig_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 *types.MpoolConfig
		if args[1] != nil {
			arg1 = args[1].(*types.MpoolConfig)
		}
		run(
			arg0,
			arg1,
...
func (_c *FullNode_MsigAddApprove_Call) Run(run func(context1 context.Context, address1 address.Address, address11 address.Address, v uint64, address12 address.Address, address13 address.Address, b bool)) *FullNode_MsigAddApprove_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg5 address.Address
		if args[5] != nil {
			arg5 = args[5].(address.Address)
		}
		var arg6 bool
		if args[6] != nil {
			arg6 = args[6].(bool)
...
func (_c *FullNode_MsigAddPropose_Call) Run(run func(context1 context.Context, address1 address.Address, address11 address.Address, address12 address.Address, b bool)) *FullNode_MsigAddPropose_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg3 address.Address
		if args[3] != nil {
			arg3 = args[3].(address.Address)
		}
		var arg4 bool
		if args[4] != nil {
			arg4 = args[4].(bool)
...
func (_c *FullNode_MsigApproveTxnHash_Call) Run(run func(context1 context.Context, address1 address.Address, v uint64, address11 address.Address, address12 address.Address, v1 types.BigInt, address13 address.Address, v2 uint64, bytes []byte)) *FullNode_MsigApproveTxnHash_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg5 types.BigInt
		if args[5] != nil {
			arg5 = args[5].(types.BigInt)
		}
		var arg6 address.Address
		if args[6] != nil {
			arg6 = args[6].(address.Address)
		}
		var arg7 uint64
		if args[7] != nil {
			arg7 = args[7].(uint64)
...
func (_c *FullNode_MsigCancelTxnHash_Call) Run(run func(context1 context.Context, address1 address.Address, v uint64, address11 address.Address, v1 types.BigInt, address12 address.Address, v2 uint64, bytes []byte)) *FullNode_MsigCancelTxnHash_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg4 types.BigInt
		if args[4] != nil {
			arg4 = args[4].(types.BigInt)
		}
		var arg5 address.Address
		if args[5] != nil {
			arg5 = args[5].(address.Address)
...
func (_c *FullNode_MsigCreate_Call) Run(run func(context1 context.Context, v uint64, addresss []address.Address, chainEpoch abi.ChainEpoch, v1 types.BigInt, address1 address.Address, v2 types.BigInt)) *FullNode_MsigCreate_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg3 abi.ChainEpoch
		if args[3] != nil {
			arg3 = args[3].(abi.ChainEpoch)
		}
		var arg4 types.BigInt
		if args[4] != nil {
			arg4 = args[4].(types.BigInt)
		...
		var arg6 types.BigInt
		if args[6] != nil {
			arg6 = args[6].(types.BigInt)
		}
		run(
			arg0,
			arg1,
...
func (_c *FullNode_NetBlockAdd_Call) Run(run func(ctx context.Context, acl api.NetBlockList)) *FullNode_NetBlockAdd_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 api.NetBlockList
		if args[1] != nil {
			arg1 = args[1].(api.NetBlockList)
		}
		run(
			arg0,
			arg1,
...
func (_c *FullNode_NetSetLimit_Call) Run(run func(ctx context.Context, scope string, limit api.NetLimit)) *FullNode_NetSetLimit_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg2 api.NetLimit
		if args[2] != nil {
			arg2 = args[2].(api.NetLimit)
		}
		run(
			arg0,
			arg1,
...
func (_c *FullNode_PaychGet_Call) Run(run func(ctx context.Context, from address.Address, to address.Address, amt types.BigInt, opts api.PaychGetOpts)) *FullNode_PaychGet_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg4 api.PaychGetOpts
		if args[4] != nil {
			arg4 = args[4].(api.PaychGetOpts)
		}
		run(
			arg0,
			arg1,
...
func (_c *FullNode_PaychNewPayment_Call) Run(run func(ctx context.Context, from address.Address, to address.Address, vouchers []api.VoucherSpec)) *FullNode_PaychNewPayment_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg3 []api.VoucherSpec
		if args[3] != nil {
			arg3 = args[3].([]api.VoucherSpec)
		}
		run(
			arg0,
			arg1,
...
func (_c *FullNode_PaychVoucherAdd_Call) Run(run func(context1 context.Context, address1 address.Address, signedVoucher *paych.SignedVoucher, bytes []byte, v types.BigInt)) *FullNode_PaychVoucherAdd_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg2 *paych.SignedVoucher
		if args[2] != nil {
			arg2 = args[2].(*paych.SignedVoucher)
		}
		var arg3 []byte
		if args[3] != nil {
			arg3 = args[3].([]byte)
...
func (_c *FullNode_StateActorCodeCIDs_Call) Run(run func(context1 context.Context, version network0.Version)) *FullNode_StateActorCodeCIDs_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 network0.Version
		if args[1] != nil {
			arg1 = args[1].(network0.Version)
		}
		run(
			arg0,
			arg1,
...
func (_c *FullNode_StateCompute_Call) Run(run func(context1 context.Context, chainEpoch abi.ChainEpoch, messages []*types.Message, tipSetKey types.TipSetKey)) *FullNode_StateCompute_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg2 []*types.Message
		if args[2] != nil {
			arg2 = args[2].([]*types.Message)
		}
		var arg3 types.TipSetKey
		if args[3] != nil {
			arg3 = args[3].(types.TipSetKey)
...
func (_c *FullNode_StateComputeDataCID_Call) Run(run func(ctx context.Context, maddr address.Address, sectorType abi.RegisteredSealProof, deals []abi.DealID, tsk types.TipSetKey)) *FullNode_StateComputeDataCID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg2 abi.RegisteredSealProof
		if args[2] != nil {
			arg2 = args[2].(abi.RegisteredSealProof)
		}
		var arg3 []abi.DealID
		if args[3] != nil {
			arg3 = args[3].([]abi.DealID)
		}
		var arg4 types.TipSetKey
		if args[4] != nil {
			arg4 = args[4].(types.TipSetKey)
...
func (_c *FullNode_StateDealProviderCollateralBounds_Call) Run(run func(context1 context.Context, paddedPieceSize abi.PaddedPieceSize, b bool, tipSetKey types.TipSetKey)) *FullNode_StateDealProviderCollateralBounds_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 abi.PaddedPieceSize
		if args[1] != nil {
			arg1 = args[1].(abi.PaddedPieceSize)
		}
		var arg2 bool
		if args[2] != nil {
			arg2 = args[2].(bool)
...
func (_c *FullNode_StateDecodeParams_Call) Run(run func(ctx context.Context, toAddr address.Address, method abi.MethodNum, params []byte, tsk types.TipSetKey)) *FullNode_StateDecodeParams_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg2 abi.MethodNum
		if args[2] != nil {
			arg2 = args[2].(abi.MethodNum)
		}
		var arg3 []byte
		if args[3] != nil {
			arg3 = args[3].([]byte)
...
func (_c *FullNode_StateGetAllocation_Call) Run(run func(ctx context.Context, clientAddr address.Address, allocationId verifreg.AllocationId, tsk types.TipSetKey)) *FullNode_StateGetAllocation_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg2 verifreg.AllocationId
		if args[2] != nil {
			arg2 = args[2].(verifreg.AllocationId)
		}
		var arg3 types.TipSetKey
		if args[3] != nil {
			arg3 = args[3].(types.TipSetKey)
...
func (_c *FullNode_StateGetClaim_Call) Run(run func(ctx context.Context, providerAddr address.Address, claimId verifreg.ClaimId, tsk types.TipSetKey)) *FullNode_StateGetClaim_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg2 verifreg.ClaimId
		if args[2] != nil {
			arg2 = args[2].(verifreg.ClaimId)
		}
		var arg3 types.TipSetKey
		if args[3] != nil {
			arg3 = args[3].(types.TipSetKey)
...
func (_c *FullNode_StateGetRandomnessFromBeacon_Call) Run(run func(ctx context.Context, personalization crypto.DomainSeparationTag, randEpoch abi.ChainEpoch, entropy []byte, tsk types.TipSetKey)) *FullNode_StateGetRandomnessFromBeacon_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 crypto.DomainSeparationTag
		if args[1] != nil {
			arg1 = args[1].(crypto.DomainSeparationTag)
		}
		var arg2 abi.ChainEpoch
		if args[2] != nil {
			arg2 = args[2].(abi.ChainEpoch)
...
func (_c *FullNode_StateListMessages_Call) Run(run func(ctx context.Context, match *api.MessageMatch, tsk types.TipSetKey, toht abi.ChainEpoch)) *FullNode_StateListMessages_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 *api.MessageMatch
		if args[1] != nil {
			arg1 = args[1].(*api.MessageMatch)
		}
		var arg2 types.TipSetKey
		if args[2] != nil {
			arg2 = args[2].(types.TipSetKey)
...
// StateMinerCreationDeposit provides a mock function for the type FullNode
func (_mock *FullNode) StateMinerCreationDeposit(ctx context.Context, tsk types.TipSetKey) (types.BigInt, error) {
	ret := _mock.Called(ctx, tsk)
...
func (_c *FullNode_StateMinerCreationDeposit_Call) RunAndReturn(run func(ctx context.Context, tsk types.TipSetKey) (types.BigInt, error)) *FullNode_StateMinerCreationDeposit_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *FullNode_StateMinerInitialPledgeCollateral_Call) Run(run func(context1 context.Context, address1 address.Address, v miner.SectorPreCommitInfo, tipSetKey types.TipSetKey)) *FullNode_StateMinerInitialPledgeCollateral_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg2 miner.SectorPreCommitInfo
		if args[2] != nil {
			arg2 = args[2].(miner.SectorPreCommitInfo)
		}
		var arg3 types.TipSetKey
		if args[3] != nil {
			arg3 = args[3].(types.TipSetKey)
...
func (_c *FullNode_StateMinerInitialPledgeForSector_Call) Run(run func(ctx context.Context, sectorDuration abi.ChainEpoch, sectorSize abi.SectorSize, verifiedSize uint64, tsk types.TipSetKey)) *FullNode_StateMinerInitialPledgeForSector_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg2 abi.SectorSize
		if args[2] != nil {
			arg2 = args[2].(abi.SectorSize)
		}
		var arg3 uint64
		if args[3] != nil {
			arg3 = args[3].(uint64)
...
func (_c *FullNode_StateMinerSectorAllocated_Call) Run(run func(context1 context.Context, address1 address.Address, sectorNumber abi.SectorNumber, tipSetKey types.TipSetKey)) *FullNode_StateMinerSectorAllocated_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg2 abi.SectorNumber
		if args[2] != nil {
			arg2 = args[2].(abi.SectorNumber)
		}
		var arg3 types.TipSetKey
		if args[3] != nil {
			arg3 = args[3].(types.TipSetKey)
...
func (_c *FullNode_StateMinerSectors_Call) Run(run func(context1 context.Context, address1 address.Address, bitField *bitfield.BitField, tipSetKey types.TipSetKey)) *FullNode_StateMinerSectors_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg2 *bitfield.BitField
		if args[2] != nil {
			arg2 = args[2].(*bitfield.BitField)
		}
		var arg3 types.TipSetKey
		if args[3] != nil {
			arg3 = args[3].(types.TipSetKey)
...
func (_c *FullNode_SyncSubmitBlock_Call) Run(run func(ctx context.Context, blk *types.BlockMsg)) *FullNode_SyncSubmitBlock_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 *types.BlockMsg
		if args[1] != nil {
			arg1 = args[1].(*types.BlockMsg)
		}
		run(
			arg0,
			arg1,
...
func (_c *FullNode_WalletImport_Call) Run(run func(context1 context.Context, keyInfo *types.KeyInfo)) *FullNode_WalletImport_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 *types.KeyInfo
		if args[1] != nil {
			arg1 = args[1].(*types.KeyInfo)
		}
		run(
			arg0,
			arg1,
...
func (_c *FullNode_WalletNew_Call) Run(run func(context1 context.Context, keyType types.KeyType)) *FullNode_WalletNew_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 types.KeyType
		if args[1] != nil {
			arg1 = args[1].(types.KeyType)
		}
		run(
			arg0,
			arg1,
...
func (_c *FullNode_WalletVerify_Call) Run(run func(context1 context.Context, address1 address.Address, bytes []byte, signature *crypto.Signature)) *FullNode_WalletVerify_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg3 *crypto.Signature
		if args[3] != nil {
			arg3 = args[3].(*crypto.Signature)
		}
		run(
			arg0,
			arg1,
