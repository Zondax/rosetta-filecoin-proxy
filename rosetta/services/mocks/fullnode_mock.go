...
func (f *FullNodeMock) MpoolPushMessage(ctx context.Context, message *filTypes.Message) (*filTypes.SignedMessage, error) {
	panic("implement me")
}
...
func (f *FullNodeMock) ClientImport(ctx context.Context, ref api.FileRef) (cid.Cid, error) {
	panic("implement me")
}
...
func (f *FullNodeMock) ClientFindData(ctx context.Context, root cid.Cid) ([]api.QueryOffer, error) {
	panic("implement me")
}

func (f *FullNodeMock) ClientMinerQueryOffer(ctx context.Context, root cid.Cid, miner address.Address) (api.QueryOffer, error) {
	panic("implement me")
}
...
func (f *FullNodeMock) ClientCalcCommP(ctx context.Context, inpath string, miner address.Address) (*api.CommPRet, error) {
	panic("implement me")
}
...
func (f *FullNodeMock) StateMinerDeadlines(ctx context.Context, a address.Address, key filTypes.TipSetKey) (*miner.Deadlines, error) {
	panic("implement me")
}
...
func (f *FullNodeMock) StateMinerInitialPledgeCollateral(ctx context.Context, a address.Address, number abi.SectorNumber, key filTypes.TipSetKey) (filTypes.BigInt, error) {
	panic("implement me")
}
...
func (f *FullNodeMock) MsigCancel(ctx context.Context, a address.Address, u uint64, a2 address.Address, a3 address.Address, bigInt filTypes.BigInt, a4 address.Address, u2 uint64, bytes []byte) (cid.Cid, error) {
	panic("implement me")
}
